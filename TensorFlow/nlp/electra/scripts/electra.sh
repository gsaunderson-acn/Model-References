...
DATASET_P1="/root/software/data/tf/data/bert/books_wiki_en_corpus/tfrecord/seq_len_128/books_wiki_en_corpus/training/books_wiki*" #change this path for dataset seq_len_128
DATA_DIR_P1=${22:-"$DATASET_P1"}
DATASET_P2="/root/software/data/tf/data/bert/books_wiki_en_corpus/tfrecord/seq_len_512/books_wiki_en_corpus/training/books_wiki*" #change this path for dataset seq_len_512
