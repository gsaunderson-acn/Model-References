...
def create_command_str(args):
    ...
    if args.dtype == 'fp32':
        ...
        cmd_parts.append(f'{bf16_flag}=full')
    else:
    ...
    if args.seed is None and args.deterministic:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', metavar='<seed>', help='Seed to be used by model.', type=int)
